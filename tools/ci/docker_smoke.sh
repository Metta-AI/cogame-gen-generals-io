...
# Substitute: gen-generals-io, coworld-gen-generals-io, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-gen-generals-io:ci)
#   SMOKE_SLUG                 game slug                        (gen-generals-io)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/gen-generals-io)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/gen-generals-io-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-gen-generals-io:ci}}"
slug="${SMOKE_SLUG:-gen-generals-io}"
